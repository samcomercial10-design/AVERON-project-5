...
(function(){
  ...
  ['f-name','f-price','f-category','f-colour','f-label','f-description','f-details','f-fit','f-delivery','f-returns','f-cj-pid','f-cj-logistics'].forEach(id=>$(id).addEventListener('input',()=>{productDirty=true;$('save-status').textContent='Unsaved changes kept while you stay in Products.'}));
